      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-primary-foreground/85">
            Refrigeración, aire acondicionado, calefacción y electricidad para
            hogares, comercios e industrias. Instalación, mantenimiento y
            reparación con respaldo profesional.
          </p>
